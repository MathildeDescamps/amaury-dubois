...
if ( $row_content_width === 'grid' ) {
	$eltdf_row_wrapper_start .= '<div class="eltdf-row-grid-section-wrapper ' . esc_attr( $grid_row_classes ) . '" ' . esc_attr( $grid_row_datas ) . ' ' . onea_elated_get_inline_style( $eltdf_grid_row_styles ) . '><div class="eltdf-row-grid-section">';
	$eltdf_row_wrapper_end   .= '</div></div>';
}

$eltdf_after_wrapper_open   = apply_filters('onea_elated_filter_vc_after_wrapper_open', '', $atts);
$eltdf_before_wrapper_close = apply_filters('onea_elated_filter_vc_before_wrapper_close', '', $atts);
$css_classes                = apply_filters('onea_elated_filter_vc_css_classes', $css_classes, $atts);
...
$output .= '<div ' . implode( ' ', $wrapper_attributes ) . ' ' . onea_elated_get_inline_style( $eltdf_vc_row_styles ) . '>';
...
echo onea_elated_get_module_part( $output );
