...
/**
 * Class OneaInstagramHelper
 */
class OneaInstagramHelper {
	/**
	 * Generates HTML for given image from Instagram feed. Defines onea_instagram_image_atts filter
	 *
	...
	public function getImageHTML( $image ) {
		...
		$imageAtts = apply_filters( 'onea_instagram_image_atts',
			array(
