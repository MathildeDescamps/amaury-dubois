...
include 'onea-instagram-helper.php';

/**
 * Class OneaInstagramApi
 */
class OneaInstagramApi {
	...
	const INSTAGRAM_CODE = 'onea_instagram_code';
	const INSTAGRAM_USER_ID = 'onea_instagram_user_id';
	const INSTAGRAM_TOKEN = 'onea_instagram_access_token';
	const INSTAGRAM_TOKEN_LONG_LIVED = 'onea_instagram_access_token_long_lived';
	const INSTAGRAM_TOKEN_LONG_LIVED_TIME = 'onea_instagram_access_token_long_lived_time';

	const FACEBOOK_CODE = 'onea_facebook_code';
	const FACEBOOK_TOKEN = 'onea_facebook_access_token';

	const CONNECTION_TYPE = 'onea_connection_type';
	...
	public function __construct() {
		...
		$this->helper = new OneaInstagramHelper();
	}
	

	/**
	 * @return OneaInstagramApi
	 */
	 ...
	 *
	 * @see OneaInstagramApi::fetchData()
	 */
	 ...
	 * @return stdClass
	 *
	 * @see OneaInstagramApi::instagramExchangeCodeForToken()
	 */
