...
namespace OneaMembership\Lib;

/**
 * Class ShortcodeLoader
 * @package OneaMembership\Lib
 */
class ShortcodeLoader {
	/**
	...
	private function addShortcodes() {
		$shortcodes_class_name = apply_filters( 'onea_membership_filter_add_vc_shortcode', $shortcodes_class_name = array() );
