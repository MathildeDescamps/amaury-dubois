...
if ( ! class_exists( 'OneaCoreDashboardRestAPI' ) ) {
	 ...
	 */
	class OneaCoreDashboardRestAPI {
		...
		public function __construct() {
			// Init variables
			$this->set_namespace( 'onea-api/v1' );
			$this->set_route( 'dashboard' );

			// Localize theme's main js script with rest variable
			add_filter( 'onea_core_dashboard_filter_js_global_variables', array( $this, 'localize_script' ) );
	...
	OneaCoreDashboardRestAPI::get_instance();
}