<div class="eltdf-core-dashboard wrap about-wrap">
	<h1 class="eltdf-cd-title"><?php esc_html_e('System Status', 'onea-core'); ?></h1>
	<h4 class="eltdf-cd-subtitle"><?php esc_html_e('Here is a general overview of your system status', 'onea-core'); ?></h4>
	<div class="eltdf-core-dashboard-inner">
		<div class="eltdf-core-dashboard-column">
			<div class="eltdf-core-dashboard-box">
				<div class="eltdf-cd-box-title-holder">
					<h2><?php esc_html_e('WordPress Environment', 'onea-core'); ?></h2>
				</div>
		...
		<div class="eltdf-core-dashboard-column">
			<div class="eltdf-core-dashboard-box">
				<div class="eltdf-cd-box-title-holder">
					<h2><?php esc_html_e('Theme Information', 'onea-core'); ?></h2>
				</div>
				<div class="eltdf-cd-box-inner">
			...
			<div class="eltdf-core-dashboard-box">
				<div class="eltdf-cd-box-title-holder">
					<h2><?php esc_html_e('Active Plugins', 'onea-core'); ?><sup>(<?php echo count($plugins); ?>)</sup></h2>
				</div>
				<div class="eltdf-cd-box-inner">
					<?php foreach ($plugins as $plugin_key => $plugin_value): ?>
						<div class="eltdf-cd-box-row">
							...
							<div class="eltdf-cdb-value"><?php esc_html_e('by', 'onea-core'); ?> <a href="<?php echo esc_url($plugin_value['author_url']); ?>"><?php echo wp_kses_post($plugin_value['author']); ?></a> - <?php echo wp_kses_post($plugin_value['version']); ?></div>
						</div>
					<?php endforeach; ?>
				</div>
			</div>
