...
namespace OneaCore\CPT\Shortcodes\TopReviewsCarousel;

use OneaCore\Lib\ShortcodeInterface;

class TopReviewsCarousel implements ShortcodeInterface {
	private $base;
	
	public function __construct() {
		$this->base = 'onea_core_top_reviews_carousel';
	...
	public function vcMap() {
		$criteria_ratings = onea_core_rating_criteria_for_vc();
		
		vc_map(
			array(
				'name'                      => esc_html__( 'Top Reviews Carousel', 'onea-core' ),
				'base'                      => $this->base,
				...
				'params'                    => array(
					...
					array(
						...
						'heading'     => esc_html__( 'Number of Reviews', 'onea-core' ),
						'description' => esc_html__( 'Leave empty for all', 'onea-core' )
					),
					array(
						'type'        => 'dropdown',
						'param_name'  => 'review_criteria',
						'heading'     => esc_html__( 'Order by Review Criteria', 'onea-core' ),
	...
	public function render( $atts, $content = null ) {
		...
		return onea_core_get_module_shortcode_template_part( 'reviews', 'top-reviews-carousel', 'top-reviews-carousel', '', $params );
	}
