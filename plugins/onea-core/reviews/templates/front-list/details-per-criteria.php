<?php if ( is_array( $post_ratings ) && count( $post_ratings ) ) { ?>
	<?php $average_rating_total = onea_core_get_total_average_rating( $post_ratings ); ?>
				...
				<div class="eltdf-grid-col-3">
					<div class="eltdf-item-reviews-average-wrapper">
						<div class="eltdf-item-reviews-average-rating">
							<?php echo esc_html( onea_core_reviews_format_rating_output( $average_rating_total ) ); ?>
						</div>
						<div class="eltdf-item-reviews-verbal-description">
                            <span class="eltdf-item-reviews-rating-icon">
                                <?php echo onea_core_reviews_get_icon_for_rating( $average_rating_total ); ?>
                            </span>
							<span class="eltdf-item-reviews-rating-description">
                                <?php echo esc_html( onea_core_reviews_get_description_for_rating( $average_rating_total ) ); ?>
                            </span>
						</div>
					</div>
				</div>
				<div class="eltdf-grid-col-9">
					<div class="eltdf-rating-percentage-wrapper">
						...
						foreach ( $post_ratings as $rating ) {
							$percentage = onea_core_post_average_rating_per_criteria( $rating );
