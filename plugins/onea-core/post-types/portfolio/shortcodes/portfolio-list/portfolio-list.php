...
namespace OneaCore\CPT\Shortcodes\Portfolio;
...
class PortfolioList implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map( array(
					'name'     => esc_html__( 'Portfolio List', 'onea-core' ),
					'base'     => $this->getBase(),
					...
					'params'   => array(
						array(
							'type'        => 'dropdown',
							'param_name'  => 'type',
							'heading'     => esc_html__( 'Portfolio List Template', 'onea-core' ),
							'value'       => array(
								esc_html__( 'Gallery', 'onea-core' ) => 'gallery',
								esc_html__( 'Masonry', 'onea-core' ) => 'masonry'
							),
							'save_always' => true,
							'admin_label' => true
						),
						array(
							...
							'heading'    => esc_html__( 'Click Behavior', 'onea-core' ),
							'value'      => array(
								esc_html__( 'Open portfolio single page on click', 'onea-core' )   => '',
								esc_html__( 'Open gallery in Pretty Photo on click', 'onea-core' ) => 'gallery'
							)
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'number_of_columns',
							'heading'     => esc_html__( 'Number of Columns', 'onea-core' ),
							'value'       => array_flip( onea_elated_get_number_of_columns_array( true ) ),
							'description' => esc_html__( 'Default value is Three', 'onea-core' ),
						),
						array(
							'type'        => 'dropdown',
						...
						array(
							...
							'heading'     => esc_html__( 'Number of Portfolios Per Page', 'onea-core' ),
							'description' => esc_html__( 'Set number of items for your portfolio list. Enter -1 to show all.', 'onea-core' ),
							'value'       => '-1'
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'image_proportions',
							'heading'     => esc_html__( 'Image Proportions', 'onea-core' ),
							'value'       => array(
								esc_html__( 'Original', 'onea-core' )  => 'full',
								esc_html__( 'Square', 'onea-core' )    => 'square',
								esc_html__( 'Landscape', 'onea-core' ) => 'landscape',
								esc_html__( 'Portrait', 'onea-core' )  => 'portrait',
								esc_html__( 'Medium', 'onea-core' )    => 'medium',
								esc_html__( 'Large', 'onea-core' )     => 'large'
							),
							'description' => esc_html__( 'Set image proportions for your portfolio list.', 'onea-core' ),
							'dependency'  => array( 'element' => 'type', 'value' => array( 'gallery' ) )
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'enable_fixed_proportions',
							'heading'     => esc_html__( 'Enable Fixed Image Proportions', 'onea-core' ),
							'value'       => array_flip( onea_elated_get_yes_no_select_array( false ) ),
							'description' => esc_html__( 'Set predefined image proportions for your masonry portfolio list. This option will apply image proportions you set in Portfolio Single page - dimensions for masonry option.', 'onea-core' ),
							'dependency'  => array( 'element' => 'type', 'value' => array( 'masonry' ) )
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'enable_image_shadow',
							'heading'     => esc_html__( 'Enable Image Shadow', 'onea-core' ),
							'value'       => array_flip( onea_elated_get_yes_no_select_array( false ) ),
							'save_always' => true
						),
						array(
							'type'        => 'autocomplete',
							'param_name'  => 'category',
							'heading'     => esc_html__( 'One-Category Portfolio List', 'onea-core' ),
							'description' => esc_html__( 'Enter one category slug (leave empty for showing all categories)', 'onea-core' )
						),
						array(
							'type'        => 'autocomplete',
							'param_name'  => 'selected_projects',
							'heading'     => esc_html__( 'Show Only Projects with Listed IDs', 'onea-core' ),
							'settings'    => array(
								'multiple'      => true,
								'sortable'      => true,
								'unique_values' => true
							),
							'description' => esc_html__( 'Delimit ID numbers by comma (leave empty for all)', 'onea-core' )
						),
						array(
							'type'        => 'autocomplete',
							'param_name'  => 'tag',
							'heading'     => esc_html__( 'One-Tag Portfolio List', 'onea-core' ),
							'description' => esc_html__( 'Enter one tag slug (leave empty for showing all tags)', 'onea-core' )
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'orderby',
						...
						array(
							...
							'heading'    => esc_html__( 'Item Style', 'onea-core' ),
							'value'      => array(
								esc_html__( 'Standard - Shader', 'onea-core' )                 => 'standard-shader',
								esc_html__( 'Standard - Switch Featured Images', 'onea-core' ) => 'standard-switch-images',
								esc_html__( 'Gallery - Overlay', 'onea-core' )                 => 'gallery-overlay',
                                esc_html__( 'Gallery - Slide From Image Right', 'onea-core' ) => 'gallery-slide-from-image-right',
								esc_html__( 'Gallery - Slide From Image Bottom', 'onea-core' ) => 'gallery-slide-from-image-bottom'
							),
							'group'      => esc_html__( 'Content Layout', 'onea-core' )
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'content_top_margin',
							'heading'    => esc_html__( 'Content Top Margin (px or %)', 'onea-core' ),
						...
						array(
							...
							'heading'    => esc_html__( 'Content Bottom Margin (px or %)', 'onea-core' ),
							'dependency' => array( 'element' => 'item_style', 'value' => array( 'standard-shader', 'standard-switch-images' ) ),
							'group'      => esc_html__( 'Content Layout', 'onea-core' )
						),
						array(
							...
							'heading'    => esc_html__( 'Enable Title', 'onea-core' ),
						...
						array(
							...
							'heading'    => esc_html__( 'Title Text Transform', 'onea-core' ),
						...
						array(
							...
							'heading'    => esc_html__( 'Enable Category', 'onea-core' ),
							'value'      => array_flip( onea_elated_get_yes_no_select_array( false, true ) ),
							'group'      => esc_html__( 'Content Layout', 'onea-core' )
						),
						array(
							...
							'heading'    => esc_html__( 'Enable Number of Images', 'onea-core' ),
							'value'      => array_flip( onea_elated_get_yes_no_select_array( false, true ) ),
							'dependency' => array( 'element' => 'type', 'value' => array( 'gallery' ) ),
							'group'      => esc_html__( 'Content Layout', 'onea-core' )
						),
						array(
							...
							'heading'    => esc_html__( 'Enable Excerpt', 'onea-core' ),
							'value'      => array_flip( onea_elated_get_yes_no_select_array( false ) ),
							'group'      => esc_html__( 'Content Layout', 'onea-core' )
						),
						array(
							...
							'heading'     => esc_html__( 'Excerpt Length', 'onea-core' ),
							'description' => esc_html__( 'Number of characters', 'onea-core' ),
						...
						array(
							...
							'heading'    => esc_html__( 'Pagination Type', 'onea-core' ),
							'value'      => array(
								esc_html__( 'None', 'onea-core' )            => 'no-pagination',
								esc_html__( 'Standard', 'onea-core' )        => 'standard',
								esc_html__( 'Load More', 'onea-core' )       => 'load-more',
								esc_html__( 'Infinite Scroll', 'onea-core' ) => 'infinite-scroll'
							),
							'group'      => esc_html__( 'Additional Features', 'onea-core' )
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'load_more_top_margin',
							'heading'    => esc_html__( 'Load More Top Margin (px or %)', 'onea-core' ),
						...
						array(
							'type'       => 'dropdown',
							'param_name' => 'filter',
							'heading'    => esc_html__( 'Enable Category Filter', 'onea-core' ),
							'value'      => array_flip( onea_elated_get_yes_no_select_array( false ) ),
							'group'      => esc_html__( 'Additional Features', 'onea-core' )
						),
						array(
							...
							'heading'    => esc_html__( 'Filter Order By', 'onea-core' ),
							'value'      => array(
								esc_html__( 'Name', 'onea-core' )  => 'name',
								esc_html__( 'Count', 'onea-core' ) => 'count',
								esc_html__( 'Id', 'onea-core' )    => 'id',
								esc_html__( 'Slug', 'onea-core' )  => 'slug'
							),
						...
						array(
							...
							'heading'    => esc_html__( 'Filter Text Transform', 'onea-core' ),
							'value'      => array_flip( onea_elated_get_text_transform_array( true ) ),
							'dependency' => array( 'element' => 'filter', 'value' => array( 'yes' ) ),
							'group'      => esc_html__( 'Additional Features', 'onea-core' )
						),
						array(
							...
							'heading'    => esc_html__( 'Filter Bottom Margin (px or %)', 'onea-core' ),
							'dependency' => array( 'element' => 'filter', 'value' => array( 'yes' ) ),
							'group'      => esc_html__( 'Additional Features', 'onea-core' )
						),
						array(
							...
							'heading'     => esc_html__( 'Enable Article Animation', 'onea-core' ),
							'value'       => array_flip( onea_elated_get_yes_no_select_array( false ) ),
							'description' => esc_html__( 'Enabling this option you will enable appears animation for your portfolio list items', 'onea-core' ),
							'group'       => esc_html__( 'Additional Features', 'onea-core' )
						)
					)
				)
	...
	public function render( $atts, $content = null ) {
		...
		$html = onea_core_get_cpt_shortcode_module_template_part( 'portfolio', 'portfolio-list', 'portfolio-holder', $params['type'], $params, $additional_params );
	...
	public function getImageSize( $params ) {
		...
		if ( ! empty( $params['image_proportions'] ) && $params['type'] == 'gallery' ) {
			...
			switch ( $image_size ) {
				case 'landscape':
					$thumb_size = 'onea_elated_image_landscape';
					break;
				case 'portrait':
					$thumb_size = 'onea_elated_image_portrait';
					break;
				case 'square':
					$thumb_size = 'onea_elated_image_square';
					break;
				case 'medium':
					$thumb_size = 'medium';
					break;
		...
		if ( $params['type'] == 'masonry' && $params['enable_fixed_proportions'] === 'yes' ) {
			...
			switch ( $fixed_image_size ) {
				...
				case 'large-width-height':
					$thumb_size = 'onea_elated_image_huge';
					break;
				default :
					$thumb_size = 'full';
					break;
	...
	public function getStandardContentStyles( $params ) {
		...
		if ( ! empty( $margin_top ) ) {
			if ( onea_elated_string_ends_with( $margin_top, '%' ) || onea_elated_string_ends_with( $margin_top, 'px' ) ) {
		...
		if ( ! empty( $margin_bottom ) ) {
			if ( onea_elated_string_ends_with( $margin_bottom, '%' ) || onea_elated_string_ends_with( $margin_bottom, 'px' ) ) {
	...
	public function getLoadMoreStyles( $params ) {
		...
		if ( ! empty( $params['load_more_top_margin'] ) ) {
			...
			if ( onea_elated_string_ends_with( $margin, '%' ) || onea_elated_string_ends_with( $margin, 'px' ) ) {
				$styles[] = 'margin-top: ' . $margin;
			} else {
				$styles[] = 'margin-top: ' . onea_elated_filter_px( $margin ) . 'px';
			}
		}
	...
	public function getFilterHolderStyles( $params ) {
		...
		if ( ! empty( $params['filter_bottom_margin'] ) ) {
			...
			if ( onea_elated_string_ends_with( $margin, '%' ) || onea_elated_string_ends_with( $margin, 'px' ) ) {
				...
				$styles[] = 'margin-bottom: ' . onea_elated_filter_px( $margin ) . 'px';
			}
		}
	...
	public function getItemLink() {
		...
		return apply_filters( 'onea_elated_filter_portfolio_external_link', $portfolio_link );
	}
	...
	public function getItemLinkTarget() {
		...
		return apply_filters( 'onea_elated_filter_portfolio_external_link_target', $portfolio_link_target );
	}
	...
	public function portfolioCategoryAutocompleteSuggester( $query ) {
		...
		if ( is_array( $post_meta_infos ) && ! empty( $post_meta_infos ) ) {
			foreach ( $post_meta_infos as $value ) {
				...
				$data['label'] = ( ( strlen( $value['portfolio_category_title'] ) > 0 ) ? esc_html__( 'Category', 'onea-core' ) . ': ' . $value['portfolio_category_title'] : '' );
				$results[]     = $data;
			}
		}
		...
		if ( ! empty( $query ) ) {
			...
			if ( is_object( $portfolio_category ) ) {
				...
				if ( ! empty( $portfolio_category_title ) ) {
					$portfolio_category_title_display = esc_html__( 'Category', 'onea-core' ) . ': ' . $portfolio_category_title;
				}
	...
	public function portfolioIdAutocompleteSuggester( $query ) {
		...
		if ( is_array( $post_meta_infos ) && ! empty( $post_meta_infos ) ) {
			foreach ( $post_meta_infos as $value ) {
				$data          = array();
				$data['value'] = $value['id'];
				$data['label'] = esc_html__( 'Id', 'onea-core' ) . ': ' . $value['id'] . ( ( strlen( $value['title'] ) > 0 ) ? ' - ' . esc_html__( 'Title', 'onea-core' ) . ': ' . $value['title'] : '' );
				$results[]     = $data;
			}
		}
		...
		if ( ! empty( $query ) ) {
			...
			if ( ! is_wp_error( $portfolio ) ) {
				...
				if ( ! empty( $portfolio_title ) ) {
					$portfolio_title_display = ' - ' . esc_html__( 'Title', 'onea-core' ) . ': ' . $portfolio_title;
				}
				
				$portfolio_id_display = esc_html__( 'Id', 'onea-core' ) . ': ' . $portfolio_id;
	...
	public function portfolioTagAutocompleteSuggester( $query ) {
		...
		if ( is_array( $post_meta_infos ) && ! empty( $post_meta_infos ) ) {
			foreach ( $post_meta_infos as $value ) {
				$data          = array();
				$data['value'] = $value['slug'];
				$data['label'] = ( ( strlen( $value['portfolio_tag_title'] ) > 0 ) ? esc_html__( 'Tag', 'onea-core' ) . ': ' . $value['portfolio_tag_title'] : '' );
				$results[]     = $data;
			}
		}
		...
		if ( ! empty( $query ) ) {
			...
			if ( is_object( $portfolio_tag ) ) {
				...
				if ( ! empty( $portfolio_tag_title ) ) {
					$portfolio_tag_title_display = esc_html__( 'Tag', 'onea-core' ) . ': ' . $portfolio_tag_title;
				}
