...
class PortfolioProjectInfo implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'     => esc_html__( 'Portfolio Project Info', 'onea-core' ),
					'base'     => $this->getBase(),
					...
					'params'   => array(
						array(
							...
							'heading'     => esc_html__( 'Selected Project', 'onea-core' ),
							'settings'    => array(
								'sortable'      => true,
								'unique_values' => true
							),
							'description' => esc_html__( 'If you left this field empty then project ID will be of the current page', 'onea-core' )
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'project_info_type',
							'heading'     => esc_html__( 'Project Info Type', 'onea-core' ),
							'value'       => array(
								esc_html__( 'Title', 'onea-core' )          => 'title',
								esc_html__( 'Category', 'onea-core' )       => 'category',
								esc_html__( 'Tag', 'onea-core' )            => 'tag',
								esc_html__( 'Author', 'onea-core' )         => 'author',
								esc_html__( 'Date', 'onea-core' )           => 'date',
								esc_html__( 'Featured Image', 'onea-core' ) => 'image'
							),
							'admin_label' => true
						),
						array(
							...
							'heading'     => esc_html__( 'Project Title Tag', 'onea-core' ),
							'value'       => array_flip( onea_elated_get_title_tag( true, array( 'p' => 'p' ) ) ),
							'description' => esc_html__( 'Set title tag for project title element', 'onea-core' ),
							'dependency'  => array( 'element' => 'project_info_type', 'value' => array( 'title' ) )
						),
						array(
							'type'        => 'textfield',
							'param_name'  => 'project_info_title',
							'heading'     => esc_html__( 'Project Info Label', 'onea-core' ),
							'description' => esc_html__( 'Add project info label before project info element/s', 'onea-core' )
						),
						array(
							'type'       => 'dropdown',
							'param_name' => 'project_info_title_tag',
							'heading'    => esc_html__( 'Project Info Label Tag', 'onea-core' ),
							'value'      => array_flip( onea_elated_get_title_tag( true, array( 'p' => 'p' ) ) ),
