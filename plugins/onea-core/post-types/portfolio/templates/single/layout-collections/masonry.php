<?php
$masonry_classes   = '';
$number_of_columns = onea_elated_get_meta_field_intersect( 'portfolio_single_masonry_columns_number' );
if ( ! empty( $number_of_columns ) ) {
	$masonry_classes .= ' eltdf-' . $number_of_columns . '-columns';
}
$space_between_items = onea_elated_get_meta_field_intersect( 'portfolio_single_masonry_space_between_items' );
...
<div class="eltdf-ps-image-holder eltdf-grid-list eltdf-grid-masonry-list eltdf-fixed-masonry-items eltdf-disable-bottom-space <?php echo esc_attr( $masonry_classes ); ?>">
	<div class="eltdf-ps-image-inner eltdf-outer-space eltdf-masonry-list-wrapper">
		...
		<?php
		$media = onea_core_get_portfolio_single_media(true);
...
<div class="eltdf-grid-row">
	...
	<div class="eltdf-grid-col-9">
		<?php onea_core_get_cpt_single_module_template_part('templates/single/parts/content', 'portfolio', $item_layout); ?>
	</div>
</div>