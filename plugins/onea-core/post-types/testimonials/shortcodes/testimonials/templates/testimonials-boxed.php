<div class="eltdf-testimonials-holder clearfix <?php echo esc_attr($holder_classes); ?>">
    <div class="eltdf-testimonials eltdf-owl-slider" <?php echo onea_elated_get_inline_attrs( $data_attr ) ?>>
        ...
        ?>
                ...
                <div class="eltdf-testimonial-content" id="eltdf-testimonials-<?php echo esc_attr( $current_id ) ?>" <?php onea_elated_inline_style( $box_styles ); ?>>
        ...
        <?php
            ...
            echo esc_html__( 'Sorry, no posts matched your criteria.', 'onea-core' );
        endif;
