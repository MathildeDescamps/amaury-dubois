<?php
namespace OneaCore\CPT\Shortcodes\ProgressBar;
...
class ProgressBar implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Progress Bar', 'onea-core' ),
					'base'                      => $this->base,
					...
					'params'                    => array(
						...
						array(
							...
							'heading'    => esc_html__( 'Percentage Type', 'onea-core' ),
							'value'      => array(
								esc_html__( 'Default', 'onea-core' )  => '',
								esc_html__( 'Floating', 'onea-core' ) => 'floating'
							),
						...
						array(
							...
							'heading'    => esc_html__( 'Active Color', 'onea-core' )
						),
						array(
							'type'       => 'colorpicker',
							'param_name' => 'color_inactive',
							'heading'    => esc_html__( 'Inactive Color', 'onea-core' )
						)
					)
				)
			);
	...
	public function render( $atts, $content = null ) {
		...
		$html = onea_core_get_shortcode_module_template_part( 'templates/progress-bar-template', 'progress-bar', '', $params );
