<?php
namespace OneaCore\CPT\Shortcodes\Tabs;
...
class Tabs implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'            => esc_html__( 'Tabs', 'onea-core' ),
					'base'            => $this->getBase(),
					...
					'params'          => array(
						...
						array(
							...
							'value'       => array(
								...
								esc_html__( 'Vertical', 'onea-core' ) => 'vertical'
							),
							'save_always' => true
						)
					)
	...
	public function render( $atts, $content = null ) {
		...
		$output = onea_core_get_shortcode_module_template_part( 'templates/tab-template', 'tabs', '', $params );
