<?php
namespace OneaCore\CPT\Shortcodes\FullScreenSections;
...
class FullScreenSectionsItem implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'            => esc_html__( 'Full Screen Sections Item', 'onea-core' ),
					'base'            => $this->base,
					...
					'params'          => array(
						...
						array(
							...
							'heading'     => esc_html__( 'Background Image Position', 'onea-core' ),
							'description' => esc_html__( 'Please insert position in format horizontal vertical position, example - center center', 'onea-core' ),
							'dependency'  => array('item' => 'background_image', 'not_empty' => true)
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'background_size',
							'heading'     => esc_html__( 'Background Image Size', 'onea-core' ),
							'value'       => array(
								esc_html__( 'Cover', 'onea-core' )   => 'cover',
								esc_html__( 'Contain', 'onea-core' ) => 'contain',
								esc_html__( 'Inherit', 'onea-core' ) => 'inherit'
							),
							'save_always' => true,
							'dependency'  => array('item' => 'background_image', 'not_empty' => true)
						),
						array(
							'type'        => 'textfield',
							'param_name'  => 'padding',
							'heading'     => esc_html__( 'Content Padding', 'onea-core' ),
							'description' => esc_html__( 'Please insert padding in format top right bottom left. You can use px or %', 'onea-core' )
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'vertical_alignment',
							'heading'     => esc_html__( 'Content Vertical Alignment', 'onea-core' ),
							'value'       => array(
						...
						array(
							...
							'heading'     => esc_html__( 'Content Horizontal Alignment', 'onea-core' ),
							'value'       => array(
								esc_html__( 'Default', 'onea-core' ) => '',
						...
						array(
							...
							'description' => esc_html__( 'Set custom link around item', 'onea-core' )
						),
						array(
							'type'       => 'dropdown',
						...
						array(
							...
							'heading'     => esc_html__( 'Header and Navigation Skin', 'onea-core' ),
							'value'       => array(
								esc_html__( 'Default', 'onea-core' ) => '',
							...
							'save_always' => true,
							'description' => esc_html__( 'Choose a predefined header style for header elements and for full screen sections navigation/pagination', 'onea-core' )
						),
						array(
							'type'        => 'attach_image',
							'param_name'  => 'image_laptop',
							'heading'     => esc_html__('Background Image for Laptops', 'onea-core'),
							'group'       => esc_html__('Responsiveness', 'onea-core')
						),
						array(
							'type'        => 'attach_image',
							'param_name'  => 'image_tablet',
							'heading'     => esc_html__('Background Image for Tablets - Landscape', 'onea-core'),
							'group'       => esc_html__('Responsiveness', 'onea-core')
						),
						array(
							'type'        => 'attach_image',
							'param_name'  => 'image_tablet_portrait',
							'heading'     => esc_html__('Background Image for Tablets - Portrait', 'onea-core'),
							'group'       => esc_html__('Responsiveness', 'onea-core')
						),
						array(
							'type'        => 'attach_image',
							'param_name'  => 'image_mobile',
							'heading'     => esc_html__('Background Image for Mobiles', 'onea-core'),
							'group'       => esc_html__('Responsiveness', 'onea-core')
						)
					)
				)
	...
	public function render( $atts, $content = null ) {
		...
		$html = onea_core_get_shortcode_module_template_part( 'templates/full-screen-sections-item', 'full-screen-sections', '', $params );
