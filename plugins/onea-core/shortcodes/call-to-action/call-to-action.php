<?php
namespace OneaCore\CPT\Shortcodes\CallToAction;
...
class CallToAction implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Call To Action', 'onea-core' ),
					'base'                      => $this->getBase(),
					...
					'params'                    => array(
						...
						array(
							'type'        => 'dropdown',
							'param_name'  => 'layout',
							'heading'     => esc_html__( 'Layout', 'onea-core' ),
							'value'       => array(
						...
						array(
							...
							'heading'    => esc_html__( 'Set Content In Grid', 'onea-core' ),
						...
						array(
							...
							'heading'    => esc_html__( 'Content Elements Proportion', 'onea-core' ),
							'value'      => array(
								esc_html__( '80/20', 'onea-core' ) => '80',
								esc_html__( '75/25', 'onea-core' ) => '75',
								esc_html__( '66/33', 'onea-core' ) => '66',
								esc_html__( '50/50', 'onea-core' ) => '50'
							),
							'dependency' => array( 'element' => 'layout', 'value' => array( 'normal' ) )
						),
						array(
						...
						array(
							...
							'value'      => esc_html__( 'I am test text for Call to Action shortcode content', 'onea-core' )
						)
					)
				)
			);
	...
	public function render( $atts, $content = null ) {
		...
		$html = onea_core_get_shortcode_module_template_part( 'templates/call-to-action', 'call-to-action', '', $params );
