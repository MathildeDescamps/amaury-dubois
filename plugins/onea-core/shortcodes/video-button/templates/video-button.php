...
<div class="eltdf-video-button-holder <?php echo esc_attr($holder_classes); ?>">
	...
	<?php } else { ?>
		<a class="eltdf-video-button-play" <?php echo onea_elated_get_inline_style($play_button_styles); ?> href="<?php echo esc_url($video_link); ?>" data-rel="prettyPhoto[video_button_pretty_photo_<?php echo esc_attr($rand); ?>]">
			<span class="eltdf-video-button-play-inner">
