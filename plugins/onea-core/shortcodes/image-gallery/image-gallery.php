<?php
namespace OneaCore\CPT\Shortcodes\ImageGallery;
...
class ImageGallery implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Image Gallery', 'onea-core' ),
					'base'                      => $this->getBase(),
					...
					'params'                    => array(
						...
						array(
							'type'        => 'dropdown',
							'param_name'  => 'type',
							'heading'     => esc_html__( 'Gallery Type', 'onea-core' ),
							'value'       => array(
								esc_html__( 'Image Grid', 'onea-core' ) => 'grid',
								esc_html__( 'Masonry', 'onea-core' )    => 'masonry',
								esc_html__( 'Slider', 'onea-core' )     => 'slider',
								esc_html__( 'Carousel', 'onea-core' )   => 'carousel'
							),
							'save_always' => true,
							'admin_label' => true
						),
						...
						array(
							...
							'heading'    => esc_html__( 'Image Behavior', 'onea-core' ),
							'value'      => array(
								esc_html__( 'None', 'onea-core' )             => '',
								esc_html__( 'Open Lightbox', 'onea-core' )    => 'lightbox',
								esc_html__( 'Open Custom Link', 'onea-core' ) => 'custom-link',
								esc_html__( 'Zoom', 'onea-core' )             => 'zoom',
								esc_html__( 'Grayscale', 'onea-core' )        => 'grayscale'
							)
						),
						array(
							'type'        => 'textarea',
							'param_name'  => 'custom_links',
							'heading'     => esc_html__( 'Custom Links', 'onea-core' ),
							'description' => esc_html__( 'Delimit links by comma', 'onea-core' ),
							'dependency'  => array( 'element' => 'image_behavior', 'value' => array( 'custom-link' ) )
						),
						array(
							'type'       => 'dropdown',
							'param_name' => 'custom_link_target',
							'heading'    => esc_html__( 'Custom Link Target', 'onea-core' ),
						...
						array(
							...
							'heading'     => esc_html__( 'Number Of Visible Items', 'onea-core' ),
							'value'       => array(
								esc_html__( 'One', 'onea-core' )   => '1',
								esc_html__( 'Two', 'onea-core' )   => '2',
								esc_html__( 'Three', 'onea-core' ) => '3',
								esc_html__( 'Four', 'onea-core' )  => '4',
								esc_html__( 'Five', 'onea-core' )  => '5',
								esc_html__( 'Six', 'onea-core' )   => '6'
							),
							'save_always' => true,
						...
						array(
							...
							'heading'     => esc_html__( 'Enable Slider Padding', 'onea-core' ),
							'description' => esc_html__( 'Padding left and right on stage (can see neighbours).', 'onea-core' ),
							'value'       => array_flip( onea_elated_get_yes_no_select_array( false ) ),
							'save_always' => true,
	...
	public function render( $atts, $content = null ) {
		...
		$html = onea_core_get_shortcode_module_template_part( 'templates/' . $params['type'], 'image-gallery', '', $params );
