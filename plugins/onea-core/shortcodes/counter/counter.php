<?php
namespace OneaCore\CPT\Shortcodes\Counter;
...
class Counter implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Counter', 'onea-core' ),
					'base'                      => $this->getBase(),
					...
					'params'                    => array(
						...
						array(
							...
							'value'       => array(
								esc_html__( 'Zero Counter', 'onea-core' )   => 'eltdf-zero-counter',
								esc_html__( 'Random Counter', 'onea-core' ) => 'eltdf-random-counter'
							),
							'save_always' => true,
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'digit',
							'heading'    => esc_html__( 'Digit', 'onea-core' )
						),
						array(
							'type'       => 'textfield',
						...
						array(
							...
							'heading'    => esc_html__( 'Digit Color', 'onea-core' ),
							'dependency' => array( 'element' => 'digit', 'not_empty' => true )
						),
						array(
							'type'       => 'textfield',
						...
						array(
							...
							'heading'     => esc_html__( 'Title Font Weight', 'onea-core' ),
	...
	public function render( $atts, $content = null ) {
		...
		$html = onea_core_get_shortcode_module_template_part( 'templates/counter', 'counter', '', $params );
	...
	private function getCounterStyles( $params ) {
		...
		if ( ! empty( $params['digit_font_size'] ) ) {
			$styles[] = 'font-size: ' . onea_elated_filter_px( $params['digit_font_size'] ) . 'px';
		}
