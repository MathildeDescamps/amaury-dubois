<?php
namespace OneaCore\CPT\Shortcodes\VerticalSplitSlider;
...
class VerticalSplitSlider implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'      => esc_html__( 'Vertical Split Slider', 'onea-core' ),
					'base'      => $this->base,
					...
					'params'    => array(
						array(
							...
							'heading'    => esc_html__( 'Enable Scrolling Animation', 'onea-core' ),
