<?php
namespace OneaCore\CPT\Shortcodes\VerticalSplitSliderContentItem;
...
class VerticalSplitSliderContentItem implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'      => esc_html__( 'Slide Content Item', 'onea-core' ),
					'base'      => $this->base,
					...
					'params'    => array(
						...
						array(
							...
							'description' => esc_html__( 'Insert padding in format: Top Right Bottom Left (e.g. 0px 0px 1px 0px)', 'onea-core' )
						),
						array(
							'type'       => 'dropdown',
							'param_name' => 'alignment',
							'heading'    => esc_html__( 'Content Alignment', 'onea-core' ),
							'value'      => array(
						...
						array(
							...
							'heading'    => esc_html__( 'Header/Bullets Style', 'onea-core' ),
							'value'      => array(
								esc_html__( 'Default', 'onea-core' ) => '',
	...
	public function render( $atts, $content = null ) {
		...
		$html = onea_core_get_shortcode_module_template_part( 'templates/vertical-split-slider-content-item-template', 'vertical-split-slider', '', $params );
