<?php
namespace OneaCore\CPT\Shortcodes\Process;
...
class Process implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'            => esc_html__( 'Process', 'onea-core' ),
					'base'            => $this->base,
					...
					'params'          => array(
						...
						array(
							...
							'value'       => array_flip( onea_elated_get_number_of_columns_array( false, array( 'one', 'five', 'six' ) ) ),
							'save_always' => true
						),
						array(
							'type'        => 'dropdown',
							...
							'value'       => array(
								esc_html__( 'Default None', 'onea-core' ) => '',
	...
	public function render( $atts, $content = null ) {
		...
		$html = onea_core_get_shortcode_module_template_part( 'templates/process-template', 'process', '', $params );
