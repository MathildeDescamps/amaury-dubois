<?php
namespace OneaCore\CPT\Shortcodes\Accordion;
...
class Accordion implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                    => esc_html__( 'Accordion', 'onea-core' ),
					'base'                    => $this->base,
					...
					'params'                  => array(
						...
						array(
							...
							'value'      => array(
								esc_html__( 'Accordion', 'onea-core' ) => 'accordion',
								esc_html__( 'Toggle', 'onea-core' )    => 'toggle'
							)
						),
						array(
							'type'       => 'dropdown',
						...
						array(
							...
							'heading'    => esc_html__( 'Background Skin', 'onea-core' ),
							'value'      => array(
								esc_html__( 'Default', 'onea-core' ) => '',
								esc_html__( 'White', 'onea-core' )   => 'white'
							),
	...
	public function render( $atts, $content = null ) {
		...
		$output = onea_core_get_shortcode_module_template_part( 'templates/accordion-holder-template', 'accordions', '', $params );
