...
namespace OneaCore\CPT\Shortcodes\AccordionTab;
...
class AccordionTab implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					"name"                    => esc_html__( 'Accordion Tab', 'onea-core' ),
					"base"                    => $this->base,
					...
					"params"                  => array(
						array(
							...
							'description' => esc_html__( 'Enter accordion section title', 'onea-core' )
						),
						array(
							'type'       => 'dropdown',
	...
	public function render( $atts, $content = null ) {
		...
		$output = onea_core_get_shortcode_module_template_part( 'templates/accordion-template', 'accordions', '', $params );
