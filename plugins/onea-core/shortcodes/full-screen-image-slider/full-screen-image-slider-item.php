...
class FullScreenImageSliderItem implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'      => esc_html__( 'Full Screen Image Slider Item', 'onea-core' ),
					'base'      => $this->base,
					...
					'params'    => array(
						...
						array(
							...
							'heading'     => esc_html__( 'Content Image Top', 'onea-core' ),
							'description' => esc_html__( 'Select image from media library', 'onea-core' )
						),
						array(
							'type'        => 'attach_image',
							'param_name'  => 'image_left',
							'heading'     => esc_html__( 'Content Image Left', 'onea-core' ),
							'description' => esc_html__( 'Select image from media library', 'onea-core' )
						),
						array(
							'type'        => 'attach_image',
							'param_name'  => 'image_right',
							'heading'     => esc_html__( 'Content Image Right', 'onea-core' ),
							'description' => esc_html__( 'Select image from media library', 'onea-core' )
						),
						array(
							'type'       => 'textfield',
						...
						array(
							'type'       => 'textfield',
							'param_name' => 'subtitle',
							'heading'    => esc_html__( 'Subitle', 'onea-core' )
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'subtitle_tag',
							'heading'     => esc_html__( 'Subitle Tag', 'onea-core' ),
							'value'       => array_flip( onea_elated_get_title_tag( true ) ),
							'save_always' => true,
						...
						array(
							...
							'heading'    => esc_html__( 'Subitle Color', 'onea-core' ),
							'dependency' => array( 'element' => 'subtitle', 'not_empty' => true )
						)
					)
				)
	...
	public function render( $atts, $content = null ) {
		...
		$html = onea_core_get_shortcode_module_template_part( 'templates/full-screen-image-slider-item', 'full-screen-image-slider', '', $params );
