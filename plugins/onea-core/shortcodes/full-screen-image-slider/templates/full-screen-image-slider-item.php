<div class="eltdf-fsis-item">
	<div class="eltdf-fsis-image" <?php onea_elated_inline_style( $image_styles ); ?>>
		<div class="eltdf-fsis-image-wrapper">
			<div class="eltdf-fsis-image-inner">
				...
				<?php } ?>
				<?php if ( ! empty( $title ) ) { ?>
					<<?php echo esc_attr( $title_tag ); ?> class="eltdf-fsis-title" <?php echo onea_elated_get_inline_style( $title_styles ); ?>><?php echo wp_kses( $title, array( 'br' => true ) ); ?></<?php echo esc_attr( $title_tag ); ?>>
				<?php } ?>
				<?php if ( ! empty( $subtitle ) ) { ?>
					<<?php echo esc_attr( $subtitle_tag ); ?> class="eltdf-fsis-subtitle" <?php echo onea_elated_get_inline_style( $subtitle_styles ); ?>><?php echo wp_kses( $subtitle, array( 'br' => true ) ); ?></<?php echo esc_attr( $subtitle_tag ); ?>>
				<?php } ?>
			</div>
		</div>
	</div>
