<?php
if ( ! function_exists( 'onea_elated_init_google_fonts_array' ) ) {
    function onea_elated_init_google_fonts_array() {
        ...
        $onea_elated_global_fonts_array = $google_fonts_decoded['items'];
    }
    add_action('after_setup_theme', 'onea_elated_init_google_fonts_array');
}