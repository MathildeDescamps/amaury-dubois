...
if ( ! function_exists( 'onea_elated_add_linea_icon_pack' ) ) {
	function onea_elated_add_linea_icon_pack( $iconCollections ) {
		$iconCollections['linea_icons'] = new OneaElatedClassLineaIcons( 'Linea Icons', 'linea_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'onea_elated_filter_add_icon_pack_into_collection', 'onea_elated_add_linea_icon_pack' );
}

if ( ! function_exists( 'onea_elated_add_linea_icon_pack_option' ) ) {
	function onea_elated_add_linea_icon_pack_option( $options ) {
		$options['linea_icons'] = esc_html__( 'Linea Icons', 'onea' );
		
		return $options;
	}
	
	add_filter( 'onea_elated_filter_add_icon_pack_into_options', 'onea_elated_add_linea_icon_pack_option' );
}

class OneaElatedClassLineaIcons implements iOneaElatedInterfaceIconCollection {
	public $icons;
	public $title;
	public $param;
	public $styleUrl;
