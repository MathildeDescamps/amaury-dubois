...
if ( ! function_exists( 'onea_elated_add_linear_icon_pack' ) ) {
	function onea_elated_add_linear_icon_pack( $iconCollections ) {
		$iconCollections['linear_icons'] = new OneaElatedClassLinearIcons( 'Linear Icons', 'linear_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'onea_elated_filter_add_icon_pack_into_collection', 'onea_elated_add_linear_icon_pack' );
}

if ( ! function_exists( 'onea_elated_add_linear_icon_pack_option' ) ) {
	function onea_elated_add_linear_icon_pack_option( $options ) {
		$options['linear_icons'] = esc_html__( 'Linear Icons', 'onea' );
		
		return $options;
	}
	
	add_filter( 'onea_elated_filter_add_icon_pack_into_options', 'onea_elated_add_linear_icon_pack_option' );
}

class OneaElatedClassLinearIcons implements iOneaElatedInterfaceIconCollection {
	public $icons;
	public $title;
	public $param;
	public $styleUrl;
