...
if ( ! function_exists( 'onea_elated_add_simple_line_icon_pack' ) ) {
	function onea_elated_add_simple_line_icon_pack( $iconCollections ) {
		$iconCollections['simple_line_icons'] = new OneaElatedClassSimpleLineIcons( 'Simple Line Icons', 'simple_line_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'onea_elated_filter_add_icon_pack_into_collection', 'onea_elated_add_simple_line_icon_pack' );
}

if ( ! function_exists( 'onea_elated_add_simple_line_icon_pack_option' ) ) {
	function onea_elated_add_simple_line_icon_pack_option( $options ) {
		$options['simple_line_icons'] = esc_html__( 'Simple Line Icons', 'onea' );
		
		return $options;
	}
	
	add_filter( 'onea_elated_filter_add_icon_pack_into_options', 'onea_elated_add_simple_line_icon_pack_option' );
	add_filter( 'onea_elated_filter_add_icon_pack_into_social_options', 'onea_elated_add_simple_line_icon_pack_option' );
}

class OneaElatedClassSimpleLineIcons implements iOneaElatedInterfaceIconCollection {
    public $icons;
    public $title;
    public $param;
    public $styleUrl;
    ...
    public function setSocialIconsArray() {
        $this->socialIcons = array(
            ''                        => '',
            'icon-social-behance'     => esc_html__('Behance', 'onea'),
            'icon-social-dribbble'    => esc_html__('Dribbble', 'onea'),
            'icon-social-dropbox'     => esc_html__('Dropbox', 'onea'),
            'icon-social-facebook'    => esc_html__('Facebook', 'onea'),
            'icon-social-foursquare'  => esc_html__('Foursquare', 'onea'),
            'icon-social-github'      => esc_html__('Github', 'onea'),
            'icon-social-gplus'       => esc_html__('Google Plus', 'onea'),
            'icon-social-instagram'   => esc_html__('Instagram', 'onea'),
            'icon-social-linkedin'    => esc_html__('LinkedIn', 'onea'),
            'icon-social-pintarest'   => esc_html__('Pinterest', 'onea'),
            'icon-social-reddit'      => esc_html__('Reddit', 'onea'),
            'icon-social-skype'       => esc_html__('Skype', 'onea'),
            'icon-social-soundcloud'  => esc_html__('Soundcloud', 'onea'),
            'icon-social-stumbleupon' => esc_html__('Stumbleupon', 'onea'),
            'icon-social-spotify'     => esc_html__('Spotify', 'onea'),
            'icon-social-tumblr'      => esc_html__('Tumblr', 'onea'),
            'icon-social-twitter'     => esc_html__('Twitter', 'onea'),
            'icon-social-youtube'     => esc_html__('Youtube', 'onea')
        );
    }
