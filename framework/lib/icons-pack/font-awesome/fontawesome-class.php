...
if ( ! function_exists( 'onea_elated_add_font_awesome_icon_pack' ) ) {
	function onea_elated_add_font_awesome_icon_pack( $iconCollections ) {
		$iconCollections['font_awesome'] = new OneaElatedClassIconsFontAwesome( 'Font Awesome', 'fa_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'onea_elated_filter_add_icon_pack_into_collection', 'onea_elated_add_font_awesome_icon_pack' );
}

if ( ! function_exists( 'onea_elated_add_font_awesome_icon_pack_option' ) ) {
	function onea_elated_add_font_awesome_icon_pack_option( $options ) {
		$options['font_awesome'] = esc_html__( 'Font Awesome', 'onea' );
		
		return $options;
	}
	
	add_filter( 'onea_elated_filter_add_icon_pack_into_options', 'onea_elated_add_font_awesome_icon_pack_option' );
	add_filter( 'onea_elated_filter_add_icon_pack_into_social_options', 'onea_elated_add_font_awesome_icon_pack_option' );
}

class OneaElatedClassIconsFontAwesome implements iOneaElatedInterfaceIconCollection {
	public $icons;
	public $title;
	public $param;
	public $styleUrl;
