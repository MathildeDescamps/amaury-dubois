...
if ( ! function_exists('onea_elated_contact_form_7_options_map') ) {

	function onea_elated_contact_form_7_options_map() {
		
		onea_elated_add_admin_page(
			array(
				'slug'  => '_contact_form7_page',
				'title' => esc_html__( 'Contact Form 7', 'onea' ),
				'icon'  => 'fa fa-envelope-o'
			)
		);
		
		$panel_contact_form_style_1 = onea_elated_add_admin_panel(
			array(
				'page'  => '_contact_form7_page',
				'name'  => 'panel_contact_form_style_1',
				'title' => esc_html__( 'Custom Style 1', 'onea' )
			)
		);
		
		//Text Typography
		
		$typography_text_group = onea_elated_add_admin_group(
			array(
				'name'        => 'typography_text_group',
				'title'       => esc_html__( 'Form Text Typography', 'onea' ),
				'description' => esc_html__( 'Setup typography for form elements text', 'onea' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$typography_text_row1 = onea_elated_add_admin_row(
			array(
		...
		onea_elated_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Focus Text Color', 'onea' ),
			)
		);
		...
		$typography_text_row2 = onea_elated_add_admin_row(
			array(
		...
		$typography_text_row3 = onea_elated_add_admin_row(
			array(
		...
		$typography_label_group = onea_elated_add_admin_group(
			array(
				'name'        => 'typography_label_group',
				'title'       => esc_html__( 'Form Label Typography', 'onea' ),
				'description' => esc_html__( 'Setup typography for form elements label', 'onea' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$typography_label_row1 = onea_elated_add_admin_row(
			array(
		...
		$typography_label_row2 = onea_elated_add_admin_row(
			array(
		...
		$background_border_group = onea_elated_add_admin_group(
			array(
				'name'        => 'background_border_group',
				'title'       => esc_html__( 'Form Elements Background and Border', 'onea' ),
				'description' => esc_html__( 'Setup form elements background and border style', 'onea' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$background_border_row1 = onea_elated_add_admin_row(
			array(
		...
		onea_elated_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Focus Background Color', 'onea' )
			)
		);
		...
		onea_elated_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Focus Background Transparency', 'onea' )
			)
		);
		
		$background_border_row2 = onea_elated_add_admin_row(
			array(
		...
		onea_elated_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Border Transparency', 'onea' ),
			)
		);
		...
		onea_elated_add_admin_field(
			array(
				...
				'label'  => esc_html__( 'Focus Border Color', 'onea' )
			)
		);
		...
		onea_elated_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Focus Border Transparency', 'onea' )
			)
		);
		
		$background_border_row3 = onea_elated_add_admin_row(
			array(
		...
		onea_elated_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Border Radius', 'onea' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		$padding_group = onea_elated_add_admin_group(
			array(
				'name'        => 'padding_group',
				'title'       => esc_html__( 'Elements Padding', 'onea' ),
				'description' => 'Setup form elements padding',
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$padding_row = onea_elated_add_admin_row(
			array(
				'name'   => 'padding_row',
		...
		onea_elated_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Padding Top', 'onea' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		onea_elated_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Padding Right', 'onea' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		onea_elated_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Padding Bottom', 'onea' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		onea_elated_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Padding Left', 'onea' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		$margin_group = onea_elated_add_admin_group(
			array(
				'name'        => 'margin_group',
				'title'       => esc_html__( 'Elements Margin', 'onea' ),
				'description' => esc_html__( 'Setup form elements margin', 'onea' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$margin_row = onea_elated_add_admin_row(
			array(
				'name'   => 'margin_row',
				'parent' => $margin_group
			)
		...
		onea_elated_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Margin Top', 'onea' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		onea_elated_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Margin Bottom', 'onea' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		onea_elated_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Textarea Height', 'onea' ),
				'description'   => esc_html__( 'Enter height for textarea form element', 'onea' ),
				'args'          => array(
					'col_width' => '3',
					'suffix'    => 'px'
				)
		...
		$button_typography_group = onea_elated_add_admin_group(
			array(
				'name'        => 'button_typography_group',
				'title'       => esc_html__( 'Button Typography', 'onea' ),
				'description' => esc_html__( 'Setup button text typography', 'onea' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$button_typography_row1 = onea_elated_add_admin_row(
			array(
		...
		$button_typography_row2 = onea_elated_add_admin_row(
			array(
		...
		$button_background_border_group = onea_elated_add_admin_group(
			array(
				'name'        => 'button_background_border_group',
				'title'       => esc_html__( 'Button Background and Border', 'onea' ),
				'description' => esc_html__( 'Setup button background and border style', 'onea' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$button_background_border_row1 = onea_elated_add_admin_row(
			array(
		...
		onea_elated_add_admin_field(
			array(
				...
				'label'  => esc_html__( 'Background Hover Color', 'onea' )
			)
		);
		...
		onea_elated_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Background Hover Transparency', 'onea' )
			)
		);
		
		$button_background_border_row2 = onea_elated_add_admin_row(
			array(
		...
		onea_elated_add_admin_field(
			array(
				...
				'label'  => esc_html__( 'Border Hover Color', 'onea' )
			)
		);
		...
		onea_elated_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Border Hover Transparency', 'onea' )
			)
		);
		
		$button_background_border_row3 = onea_elated_add_admin_row(
			array(
		...
		onea_elated_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Button Height', 'onea' ),
				'args'          => array(
					'col_width' => '3',
					'suffix'    => 'px'
				)
		...
		onea_elated_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Button Left/Right Padding', 'onea' ),
				'args'          => array(
					'col_width' => '3',
					'suffix'    => 'px'
				)
		...
		$panel_contact_form_style_2 = onea_elated_add_admin_panel(array(
			'page'	=> '_contact_form7_page',
			'name'	=> 'panel_contact_form_style_2',
			'title'	=> esc_html__('Custom Style 2', 'onea')
		));

		//Text Typography

		$typography_text_group = onea_elated_add_admin_group(array(
			'name'			=> 'typography_text_group',
			'title'			=> esc_html__('Form Text Typography', 'onea'),
			'description'	=> esc_html__('Setup typography for form elements text', 'onea'),
		...
		$typography_text_row1 = onea_elated_add_admin_row(array(
			'name'		=> 'typography_text_row1',
			'parent'	=> $typography_text_group
		));
		...
		$typography_text_row2 = onea_elated_add_admin_row(array(
			'name'		=> 'typography_text_row2',
			'next'		=> true,
			'parent'	=> $typography_text_group
		));
		...
		$typography_text_row3 = onea_elated_add_admin_row(array(
			'name'		=> 'typography_text_row3',
			'next'		=> true,
			'parent'	=> $typography_text_group
		));
		...
		$typography_label_group = onea_elated_add_admin_group(array(
			'name'			=> 'typography_label_group',
			'title'			=> esc_html__('Form Label Typography', 'onea'),
			'description'	=> esc_html__('Setup typography for form elements label', 'onea'),
			'parent'		=> $panel_contact_form_style_2
		...
		$typography_label_row1 = onea_elated_add_admin_row(array(
			'name'		=> 'typography_label_row1',
			'parent'	=> $typography_label_group
		));
		...
		$typography_label_row2 = onea_elated_add_admin_row(array(
			'name'		=> 'typography_label_row2',
			'next'		=> true,
			'parent'	=> $typography_label_group
		));
		...
		$background_border_group = onea_elated_add_admin_group(array(
			'name'			=> 'background_border_group',
			'title'			=> esc_html__('Form Elements Background and Border', 'onea'),
			'description'	=> esc_html__('Setup form elements background and border style', 'onea'),
			'parent'		=> $panel_contact_form_style_2
		...
		$background_border_row1 = onea_elated_add_admin_row(array(
			'name'		=> 'background_border_row1',
			'parent'	=> $background_border_group
		));
		...
		$background_border_row2 = onea_elated_add_admin_row(array(
			'name'		=> 'background_border_row2',
			'next'		=> true,
			'parent'	=> $background_border_group
		));
		...
		$background_border_row3 = onea_elated_add_admin_row(array(
			'name'		=> 'background_border_row3',
			'next'		=> true,
			'parent'	=> $background_border_group
		));
		...
		$padding_group = onea_elated_add_admin_group(array(
			'name'			=> 'padding_group',
			'title'			=> esc_html__('Elements Padding', 'onea'),
			'description'	=> 'Setup form elements padding',
			'parent'		=> $panel_contact_form_style_2
		...
		$padding_row = onea_elated_add_admin_row(array(
			'name'		=> 'padding_row',
			'parent'	=> $padding_group
		));
		...
		$margin_group = onea_elated_add_admin_group(array(
			'name'			=> 'margin_group',
			'title'			=> esc_html__('Elements Margin', 'onea'),
			'description'	=> esc_html__('Setup form elements margin', 'onea'),
			'parent'		=> $panel_contact_form_style_2
		...
		$margin_row = onea_elated_add_admin_row(array(
			'name'		=> 'margin_row',
			'parent'	=> $margin_group
		));
		...
		$button_typography_group = onea_elated_add_admin_group(array(
			'name'			=> 'button_typography_group',
			'title'			=> esc_html__('Button Typography', 'onea'),
			'description'	=> esc_html__('Setup button text typography', 'onea'),
			'parent'		=> $panel_contact_form_style_2
		...
		$button_typography_row1 = onea_elated_add_admin_row(array(
			'name'		=> 'button_typography_row1',
			'parent'	=> $button_typography_group
		));
		...
		$button_typography_row2 = onea_elated_add_admin_row(array(
			'name'		=> 'button_typography_row2',
			'next'		=> true,
			'parent'	=> $button_typography_group
		));
		...
		$button_background_border_group = onea_elated_add_admin_group(array(
			'name'			=> 'button_background_border_group',
			'title'			=> esc_html__('Button Background and Border', 'onea'),
			'description'	=> esc_html__('Setup button background and border style', 'onea'),
			'parent'		=> $panel_contact_form_style_2
		...
		$button_background_border_row1 = onea_elated_add_admin_row(array(
			'name'		=> 'button_background_border_row1',
			'parent'	=> $button_background_border_group
		));
		...
		$button_background_border_row2 = onea_elated_add_admin_row(array(
			'name'		=> 'button_background_border_row2',
			'next'		=> true,
			'parent'	=> $button_background_border_group
		));
		...
		$button_background_border_row3 = onea_elated_add_admin_row(array(
			'name'		=> 'button_background_border_row3',
			'next'		=> true,
			'parent'	=> $button_background_border_group
		));
        ...
        $panel_contact_form_style_3 = onea_elated_add_admin_panel(array(
            'page'	=> '_contact_form7_page',
            'name'	=> 'panel_contact_form_style_3',
            'title'	=> esc_html__('Custom Style 3', 'onea')
        ));
        ...
        $typography_label_row3 = onea_elated_add_admin_row(array(
        ...
        $button_typography_row3 = onea_elated_add_admin_row(array(
	...
	add_action( 'onea_elated_action_options_map', 'onea_elated_contact_form_7_options_map', onea_elated_set_options_map_position( 'contact_form_7' ) );
}