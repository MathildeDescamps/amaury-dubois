...
// if ( ! function_exists( 'onea_elated_header_bottom_margin_styles' ) ) {
//     /**
//      * Generates styles for menu area
//      */
//     function onea_elated_header_bottom_margin_styles() {
...
//         if ( $menu_area_height !== '' ) {
//             $menu_area_bottom_styles['margin-top'] = '-' . onea_elated_filter_px( $menu_area_height ) . 'px';
//         }

//         echo onea_elated_dynamic_css( $menu_area_bottom_selectors, $menu_area_bottom_styles );

//     }

//     add_action( 'onea_elated_action_style_dynamic', 'onea_elated_header_bottom_margin_styles' );
// }

if ( ! function_exists( 'onea_elated_header_bottom_menu_styles' ) ) {
    function onea_elated_header_bottom_menu_styles() {
    ...
    add_action( 'onea_elated_action_style_dynamic', 'onea_elated_header_bottom_menu_styles' );
}

if ( ! function_exists( 'onea_elated_header_bottom_main_menu_styles' ) ) {
    /**
     * Generates styles for vertical main main menu
     */
    function onea_elated_header_bottom_main_menu_styles() {
    ...
    add_action( 'onea_elated_action_style_dynamic', 'onea_elated_header_bottom_main_menu_styles' );
}