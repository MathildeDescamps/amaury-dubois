<?php
if($show_header_top) {
	do_action('onea_elated_action_before_header_top');
	?>
	...
	<div class="eltdf-top-bar">
		<?php do_action( 'onea_elated_action_after_header_top_html_open' ); ?>
		...
		<?php do_action( 'onea_elated_action_before_header_top_html_close' ); ?>
	</div>
	
	<?php do_action('onea_elated_action_after_header_top');
}