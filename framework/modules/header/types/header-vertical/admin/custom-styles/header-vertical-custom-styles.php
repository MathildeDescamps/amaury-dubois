...
if ( ! function_exists( 'onea_elated_vertical_menu_styles' ) ) {
	function onea_elated_vertical_menu_styles() {
	...
	add_action( 'onea_elated_action_style_dynamic', 'onea_elated_vertical_menu_styles' );
}

if ( ! function_exists( 'onea_elated_vertical_main_menu_styles' ) ) {
	/**
	 * Generates styles for vertical main main menu
	 */
	function onea_elated_vertical_main_menu_styles() {
		...
		if ( ! empty( $menu_top_margin ) ) {
			$menu_holder_styles['margin-top'] = onea_elated_filter_px( $menu_top_margin ) . 'px';
		}
		if ( ! empty( $menu_bottom_margin ) ) {
			$menu_holder_styles['margin-bottom'] = onea_elated_filter_px( $menu_bottom_margin ) . 'px';
		}
		...
		echo onea_elated_dynamic_css( $menu_holder_selector, $menu_holder_styles );
	...
	add_action( 'onea_elated_action_style_dynamic', 'onea_elated_vertical_main_menu_styles' );
}