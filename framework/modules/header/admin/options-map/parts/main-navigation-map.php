...
if ( ! function_exists( 'onea_elated_get_hide_dep_for_header_main_menu_options' ) ) {
	function onea_elated_get_hide_dep_for_header_main_menu_options() {
		$hide_dep_options = apply_filters( 'onea_elated_filter_header_main_menu_hide_global_option', $hide_dep_options = array() );
		
		return $hide_dep_options;
	}
}

if ( ! function_exists( 'onea_elated_header_main_navigation_options_map' ) ) {
	function onea_elated_header_main_navigation_options_map() {
		$hide_dep_options = onea_elated_get_hide_dep_for_header_main_menu_options();
		
		$panel_main_menu = onea_elated_add_admin_panel(
			array(
				'title'           => esc_html__( 'Main Menu', 'onea' ),
		...
		onea_elated_add_admin_section_title(
			array(
				...
				'title'  => esc_html__( 'Main Menu General Settings', 'onea' )
			)
		);
		...
		$drop_down_group = onea_elated_add_admin_group(
			array(
				...
				'description' => esc_html__( 'Choose a color and transparency for the main menu background (0 = fully transparent, 1 = opaque)', 'onea' )
			)
		);
		
		$drop_down_row1 = onea_elated_add_admin_row(
			array(
		...
		onea_elated_add_admin_field(
			array(
				...
				'label'         => esc_html__( 'Main Dropdown Menu Appearance', 'onea' ),
				'description'   => esc_html__( 'Choose appearance for dropdown menu', 'onea' ),
				'options'       => array(
					'dropdown-default'        => esc_html__( 'Default', 'onea' ),
					'dropdown-animate-height' => esc_html__( 'Animate Height', 'onea' )
				)
			)
		);
		...
		$first_level_group = onea_elated_add_admin_group(
			array(
				...
				'description' => esc_html__( 'Define styles for 1st level in Top Navigation Menu', 'onea' )
			)
		);
		...
		onea_elated_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Light Menu Hover Text Color', 'onea' ),
			)
		);
		...
		onea_elated_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Light Menu Active Text Color', 'onea' ),
			)
		);
		
		$first_level_row4 = onea_elated_add_admin_row(
			array(
				'parent' => $first_level_group,
		...
		onea_elated_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Dark Menu Hover Text Color', 'onea' ),
			)
		);
		...
		onea_elated_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Dark Menu Active Text Color', 'onea' ),
			)
		);
		
		$first_level_row5 = onea_elated_add_admin_row(
			array(
				'parent' => $first_level_group,
		...
		$first_level_row6 = onea_elated_add_admin_row(
			array(
				'parent' => $first_level_group,
		...
		$first_level_row7 = onea_elated_add_admin_row(
			array(
				'parent' => $first_level_group,
		...
		onea_elated_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Padding Left/Right', 'onea' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		onea_elated_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Margin Left/Right', 'onea' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		$second_level_group = onea_elated_add_admin_group(
			array(
				...
				'title'       => esc_html__( '2nd Level Menu', 'onea' ),
				'description' => esc_html__( 'Define styles for 2nd level in Top Navigation Menu', 'onea' )
			)
		);
		...
		$second_level_wide_group = onea_elated_add_admin_group(
			array(
				'parent'      => $panel_main_menu,
				'name'        => 'second_level_wide_group',
				'title'       => esc_html__( '2nd Level Wide Menu', 'onea' ),
				'description' => esc_html__( 'Define styles for 2nd level in Wide Menu', 'onea' )
			)
		);
		
		$second_level_wide_row1 = onea_elated_add_admin_row(
			array(
		...
		$second_level_wide_row2 = onea_elated_add_admin_row(
			array(
				'parent' => $second_level_wide_group,
		...
		$second_level_wide_row3 = onea_elated_add_admin_row(
			array(
				'parent' => $second_level_wide_group,
		...
		$third_level_group = onea_elated_add_admin_group(
			array(
				...
				'title'       => esc_html__( '3nd Level Menu', 'onea' ),
				'description' => esc_html__( 'Define styles for 3nd level in Top Navigation Menu', 'onea' )
			)
		);
		...
		$third_level_wide_group = onea_elated_add_admin_group(
			array(
				'parent'      => $panel_main_menu,
				'name'        => 'third_level_wide_group',
				'title'       => esc_html__( '3rd Level Wide Menu', 'onea' ),
				'description' => esc_html__( 'Define styles for 3rd level in Wide Menu', 'onea' )
			)
		);
		
		$third_level_wide_row1 = onea_elated_add_admin_row(
			array(
		...
		$third_level_wide_row2 = onea_elated_add_admin_row(
			array(
				'parent' => $third_level_wide_group,
		...
		$third_level_wide_row3 = onea_elated_add_admin_row(
			array(
				'parent' => $third_level_wide_group,
	...
	add_action( 'onea_elated_action_header_main_navigation_options_map', 'onea_elated_header_main_navigation_options_map', 10, 1 );
}