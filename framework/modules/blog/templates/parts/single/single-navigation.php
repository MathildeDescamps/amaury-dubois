<?php
$blog_single_navigation = onea_elated_options()->getOptionValue('blog_single_navigation') === 'no' ? false : true;
$blog_navigation_through_same_category = onea_elated_options()->getOptionValue('blog_navigation_through_same_category') === 'no' ? false : true;
?>
			...
			<?php
				...
				$post_navigation = array(
					'prev' => array(
						...
						'label' => '<span class="eltdf-blog-single-nav-label">'.esc_html__('previous', 'onea').'</span>'
					),
					'next' => array(
						'mark' => '<span class="eltdf-blog-single-nav-mark ion-ios-arrow-thin-right"></span>',
						'label' => '<span class="eltdf-blog-single-nav-label">'.esc_html__('next', 'onea').'</span>'
					)
				);
