<?php
namespace OneaCore\CPT\Shortcodes\BlogSlider;
...
class BlogSlider implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		vc_map(
			array(
				'name'                      => esc_html__( 'Blog Slider', 'onea' ),
				'base'                      => $this->base,
				...
				'params'                    => array(
					array(
						...
						'value'       => array(
							esc_html__( 'Slider', 'onea' )            => 'slider',
							esc_html__( 'Carousel', 'onea' )          => 'carousel',
							esc_html__( 'Carousel Centered', 'onea' ) => 'carousel-centered'
						),
						'save_always' => true
					),
					array(
	...
	public function render( $atts, $content = null ) {
		...
		onea_elated_get_module_template_part( 'shortcodes/blog-slider/holder', 'blog', '', $params );
