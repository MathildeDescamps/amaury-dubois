<?php
namespace OneaCore\CPT\Shortcodes\BlogList;
...
class BlogList implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		vc_map(
			array(
				'name'                      => esc_html__( 'Blog List', 'onea' ),
				'base'                      => $this->base,
				...
				'params'                    => array(
					array(
						...
						'value'       => array(
							...
							esc_html__( 'Boxed', 'onea' )    => 'boxed',
							esc_html__( 'Masonry', 'onea' )  => 'masonry',
							esc_html__( 'Minimal', 'onea' )  => 'minimal'
						),
						'save_always' => true
					),
					array(
						...
						'heading'    => esc_html__( 'Number of Posts', 'onea' )
					),
					array(
						'type'       => 'dropdown',
					...
					array(
						'type'        => 'autocomplete',
						'param_name'  => 'category',
						'heading'     => esc_html__( 'Category', 'onea' ),
						'description' => esc_html__( 'Enter one category slug (leave empty for showing all categories)', 'onea' )
					),
					array(
						'type'       => 'dropdown',
						'param_name' => 'image_size',
						'heading'    => esc_html__( 'Image Size', 'onea' ),
						'value'      => array(
							...
							esc_html__( 'Thumbnail', 'onea' ) => 'thumbnail',
					...
					array(
						...
						'group'      => esc_html__( 'Post Info', 'onea' )
					),
					array(
						'type'       => 'dropdown',
					...
					array(
						...
						'heading'     => esc_html__( 'Text Length', 'onea' ),
						'description' => esc_html__( 'Number of words', 'onea' ),
					...
					array(
						...
						'heading'    => esc_html__( 'Enable Post Info Image', 'onea' ),
					...
					array(
						...
						'heading'    => esc_html__( 'Enable Post Info Section', 'onea' ),
						'value'      => array_flip( onea_elated_get_yes_no_select_array( false, true ) ),
						'dependency' => Array( 'element' => 'type', 'value'   => array( 'standard', 'boxed', 'masonry' ) ),
						'group'      => esc_html__( 'Post Info', 'onea' )
					),
					array(
						...
						'heading'    => esc_html__( 'Enable Post Info Author', 'onea' ),
						'value'      => array_flip( onea_elated_get_yes_no_select_array( false, true ) ),
					...
					array(
						...
						'heading'    => esc_html__( 'Enable Post Info Date', 'onea' ),
						'value'      => array_flip( onea_elated_get_yes_no_select_array( false, true ) ),
						'dependency' => Array( 'element' => 'post_info_section', 'value' => array( 'yes' ) ),
						'group'      => esc_html__( 'Post Info', 'onea' )
					),
					array(
						...
						'heading'    => esc_html__( 'Enable Post Info Category', 'onea' ),
						'value'      => array_flip( onea_elated_get_yes_no_select_array( false, true ) ),
						'dependency' => Array( 'element' => 'post_info_section', 'value' => array( 'yes' ) ),
						'group'      => esc_html__( 'Post Info', 'onea' )
					),
					array(
						...
						'heading'    => esc_html__( 'Enable Post Info Comments', 'onea' ),
					...
					array(
						...
						'heading'    => esc_html__( 'Enable Post Info Share', 'onea' ),
						'value'      => array_flip( onea_elated_get_yes_no_select_array( false ) ),
						'dependency' => Array( 'element' => 'post_info_section', 'value' => array( 'yes' ) ),
						'group'      => esc_html__( 'Post Info', 'onea' )
					),
					array(
						...
						'heading'    => esc_html__( 'Enable Post Info Excerpt', 'onea' ),
						'value'      => array_flip( onea_elated_get_yes_no_select_array( false ) ),
						'dependency' => Array( 'element' => 'post_info_section', 'value' => array( 'yes' ) ),
						'group'      => esc_html__( 'Post Info', 'onea' )
					),
					array(
						...
						'heading'    => esc_html__( 'Pagination Type', 'onea' ),
						'value'      => array(
							esc_html__( 'None', 'onea' )            => 'no-pagination',
							esc_html__( 'Standard', 'onea' )        => 'standard-shortcodes',
							esc_html__( 'Load More', 'onea' )       => 'load-more',
							esc_html__( 'Infinite Scroll', 'onea' ) => 'infinite-scroll'
						),
						'group'      => esc_html__( 'Additional Features', 'onea' )
					)
				)
			)
		);
	...
	public function render( $atts, $content = null ) {
		...
		onea_elated_get_module_template_part( 'shortcodes/blog-list/holder', 'blog', $params['type'], $params );
	...
	public function blogCategoryAutocompleteSuggester( $query ) {
		...
		if ( is_array( $post_meta_infos ) && ! empty( $post_meta_infos ) ) {
			foreach ( $post_meta_infos as $value ) {
				...
				$data['label'] = ( ( strlen( $value['category_title'] ) > 0 ) ? esc_html__( 'Category', 'onea' ) . ': ' . $value['category_title'] : '' );
				$results[]     = $data;
			}
		}
		...
		if ( ! empty( $query ) ) {
			...
			if ( is_object( $category ) ) {
				...
				if ( ! empty( $category_title ) ) {
					$category_title_display = esc_html__( 'Category', 'onea' ) . ': ' . $category_title;
				}
