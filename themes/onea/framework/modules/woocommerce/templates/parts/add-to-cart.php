...
if($display_button === 'yes') {
	...
	$button_styles = (isset($button_styles)) ? $button_styles : '';
	?>
	
	<div class="eltdf-<?php echo esc_attr($class_name); ?>-add-to-cart <?php echo esc_attr($buttonSkinClass); ?> " <?php echo onea_elated_get_inline_style($button_styles); ?>>
		<?php echo apply_filters( 'onea_elated_filter_product_list_add_to_cart_link',
