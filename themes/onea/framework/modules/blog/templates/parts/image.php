...
$blog_list_image_id  = ! empty( $image_meta ) && onea_elated_blog_item_has_link() ? onea_elated_get_attachment_id_from_url( $image_meta ) : '';
?>

<?php if ( $has_featured ) { ?>
	<div class="eltdf-post-image">
		<?php if ( onea_elated_blog_item_has_link() ) { ?>
		...
		<?php } ?>
		<?php do_action('onea_elated_action_blog_inside_image_tag')?>
	</div>
<?php } ?>