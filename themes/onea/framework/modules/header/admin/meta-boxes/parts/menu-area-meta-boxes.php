...
if ( ! function_exists( 'onea_elated_get_hide_dep_for_header_menu_area_meta_boxes' ) ) {
	function onea_elated_get_hide_dep_for_header_menu_area_meta_boxes() {
		$hide_dep_options = apply_filters( 'onea_elated_filter_header_menu_area_hide_meta_boxes', $hide_dep_options = array() );
		
		return $hide_dep_options;
	}
}

if ( ! function_exists( 'onea_elated_header_menu_area_meta_options_map' ) ) {
	function onea_elated_header_menu_area_meta_options_map( $header_meta_box ) {
		$hide_dep_options = onea_elated_get_hide_dep_for_header_menu_area_meta_boxes();
		...
		onea_elated_create_meta_box_field(
			array(
				...
				'description' => esc_html__( 'Set grid background transparency for menu area (0 = fully transparent, 1 = opaque)', 'onea' ),
				'parent'      => $menu_area_in_grid_container,
				'args'        => array(
					'col_width' => 2
				)
		...
		onea_elated_create_meta_box_field(
			array(
				...
				'description'   => esc_html__( 'Set shadow on grid menu area', 'onea' ),
				'parent'        => $menu_area_in_grid_container,
				'default_value' => '',
				'options'       => onea_elated_get_yes_no_select_array()
			)
		...
		onea_elated_create_meta_box_field(
			array(
				...
				'description'   => esc_html__( 'Set border on grid menu area', 'onea' ),
				'parent'        => $menu_area_in_grid_container,
				'default_value' => '',
				'options'       => onea_elated_get_yes_no_select_array()
			)
		...
		onea_elated_create_meta_box_field(
			array(
				...
				'description' => esc_html__( 'Choose a background color for menu area', 'onea' ),
				'parent'      => $menu_area_container
			)
		);
		...
		onea_elated_create_meta_box_field(
			array(
				...
				'description' => esc_html__( 'Choose a transparency for the menu area background color (0 = fully transparent, 1 = opaque)', 'onea' ),
				'parent'      => $menu_area_container,
				'args'        => array(
					'col_width' => 2
				)
		...
		$menu_area_border_bottom_color_container = onea_elated_add_admin_container(
			array(
				'type'            => 'container',
		...
		onea_elated_create_meta_box_field(
			array(
				...
				'description' => esc_html__( 'Enter value in px or percentage to define menu area side padding', 'onea' ),
				'parent'      => $menu_area_container,
				'args'        => array(
					'col_width' => 3,
		...
		do_action( 'onea_elated_header_menu_area_additional_meta_boxes_map', $menu_area_container );
	}
	
	add_action( 'onea_elated_action_header_menu_area_meta_boxes_map', 'onea_elated_header_menu_area_meta_options_map', 10, 1 );
}