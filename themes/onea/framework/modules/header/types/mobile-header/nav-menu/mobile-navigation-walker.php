...
if (!class_exists('OneaElatedClassMobileNavigationWalker')) {
	class OneaElatedClassMobileNavigationWalker extends Walker_Nav_Menu {
		...
		function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
			...
			if($item->hide == ""){
				...
				if($args->has_children) {
					$item_output .= '<span class="mobile_arrow"><i class="eltdf-sub-arrow "></i><i class="ion-ios-arrow-right"></i></span>';
				}
			}
