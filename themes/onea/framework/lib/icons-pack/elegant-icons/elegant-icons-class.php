...
if ( ! function_exists( 'onea_elated_add_font_elegant_icon_pack' ) ) {
	function onea_elated_add_font_elegant_icon_pack( $iconCollections ) {
		$iconCollections['font_elegant'] = new OneaElatedClassIconsFontElegant( 'Font Elegant', 'fe_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'onea_elated_filter_add_icon_pack_into_collection', 'onea_elated_add_font_elegant_icon_pack' );
}

if ( ! function_exists( 'onea_elated_add_font_elegant_icon_pack_option' ) ) {
	function onea_elated_add_font_elegant_icon_pack_option( $options ) {
		$options['font_elegant'] = esc_html__( 'Font Elegant', 'onea' );
		
		return $options;
	}
	
	add_filter( 'onea_elated_filter_add_icon_pack_into_options', 'onea_elated_add_font_elegant_icon_pack_option' );
	add_filter( 'onea_elated_filter_add_icon_pack_into_social_options', 'onea_elated_add_font_elegant_icon_pack_option' );
}

class OneaElatedClassIconsFontElegant implements iOneaElatedInterfaceIconCollection {
	public $icons;
	public $title;
	public $param;
	public $styleUrl;
