...
if ( ! function_exists( 'onea_elated_add_dripicons_icon_pack' ) ) {
	function onea_elated_add_dripicons_icon_pack( $iconCollections ) {
		$iconCollections['dripicons'] = new OneaElatedClassDripicons( 'Dripicons', 'dripicon' );
		
		return $iconCollections;
	}
	
	add_filter( 'onea_elated_filter_add_icon_pack_into_collection', 'onea_elated_add_dripicons_icon_pack' );
}

if ( ! function_exists( 'onea_elated_add_dripicons_icon_pack_option' ) ) {
	function onea_elated_add_dripicons_icon_pack_option( $options ) {
		$options['dripicons'] = esc_html__( 'Dripicons', 'onea' );
		
		return $options;
	}
	
	add_filter( 'onea_elated_filter_add_icon_pack_into_options', 'onea_elated_add_dripicons_icon_pack_option' );
}

class OneaElatedClassDripicons implements iOneaElatedInterfaceIconCollection {
    public $icons;
    public $title;
    public $param;
    public $styleUrl;
