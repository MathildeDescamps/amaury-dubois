...
if ( ! function_exists( 'onea_elated_add_ion_icon_pack' ) ) {
	function onea_elated_add_ion_icon_pack( $iconCollections ) {
		$iconCollections['ion_icons'] = new OneaElatedClassIonIcons( 'Ion Icons', 'ion_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'onea_elated_filter_add_icon_pack_into_collection', 'onea_elated_add_ion_icon_pack' );
}

if ( ! function_exists( 'onea_elated_add_ion_icon_pack_option' ) ) {
	function onea_elated_add_ion_icon_pack_option( $options ) {
		$options['ion_icons'] = esc_html__( 'Ion Icons', 'onea' );
		
		return $options;
	}
	
	add_filter( 'onea_elated_filter_add_icon_pack_into_options', 'onea_elated_add_ion_icon_pack_option' );
	add_filter( 'onea_elated_filter_add_icon_pack_into_social_options', 'onea_elated_add_ion_icon_pack_option' );
}

class OneaElatedClassIonIcons implements iOneaElatedInterfaceIconCollection {
	public $icons;
	public $socialIcons;
    public $title;
	public $param;
