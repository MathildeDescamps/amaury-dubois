 ...
 */
$product_info_position = onea_elated_options()->getOptionValue('eltdf_woo_product_list_info_position');
?>
<li <?php wc_product_class( '', $product ); ?>>
	...
	if($product_info_position === 'info_below_image') {
		...
		do_action( 'onea_elated_action_woo_pl_info_below_image' );
		
	} else if($product_info_position === 'info_on_image_hover') {
		
		do_action( 'onea_elated_action_woo_pl_info_on_image_hover' );
	}
